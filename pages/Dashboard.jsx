    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <div className="text-xl md:text-2xl font-medium text-gray-300 mb-6">
        ...
        >
          ...
          <a
            href="/resume.pdf"
            download
            className="group inline-flex items-center px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-full transition-all duration-300 hover:scale-105 backdrop-blur-sm border border-white/20"
          >
            Download Resume
        ...
        >
          ...
          <div className="p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10">
            <h3 className="text-2xl font-bold text-white mb-2">9.2</h3>
